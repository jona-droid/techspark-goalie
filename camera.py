...
# Define "Green" color range (adjust for your ball color)
# If your ball is red/blue, change these values!
lower_color = np.array([40, 70, 70])   # Lower Green
upper_color = np.array([80, 255, 255]) # Upper Green
